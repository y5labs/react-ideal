  ...
  return <div ref={parentRef} className='timeline-axis'>
    <div style={{ width: `${col_v.totalSize}px`, position: 'relative' }}>
      {props.render(col_v.virtualItems, (i, s) =>
        <div
          key={i.index}
          style={{ width: `${i.size}px`, transform: `translateX(${i.start}px)` }}>
          {s}
        </div>
      )}
    </div>
...
const TaskAxis = props => {
  ...
  return <div ref={parentRef} className='task-axis'>
...
const Schedule = props => {
  ...
  return <div {...events} ref={parentRef} className='schedule-grid'>
    <div
      style={{
